...
- `GUIDE_5W1H.md` — **처음 보는 사람을 위한 5W1H 설명서.** 프롬프트를 읽기 전에 이 문서를 먼저 보면 된다.
- `CORS_RINEX30S_GNSS_interference_V7_1.md` — 현재 판(V7.1). V6 계약을 그대로 계승하고, V7에서 **역할이 다른 여러 워커 프로세스의 병렬 실행 계약(39~41절)**, V7.1에서 **미규정 사례·실행 세션·실측 반영 계약(42~44절)**을 추가했다. 앞 판의 조항은 삭제·완화되지 않았다.
